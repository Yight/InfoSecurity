(function( $, window, document, undefined ) {
    $(document).ready(function() {
        var driver_behaviour_oTable;
        var driver_behaviour_search_oTable;
...
/*********************************blackIp******************************************/
    if( $.fn.dataTable ) {
        var $selectrow = null;
            ...
            driver_behaviour_oTable = $("#driver_behaviour").dataTable({
                "oLanguage": {
                    "sProcessing":   "处理中...",
                ...
                "bServerSide": true,
                "sAjaxSource": "/ajax/get_driver_behaviour_list/",
                ...
                "fnRowCallback":function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
                    var allphtml4 = aData[8];
                    if (aData[8].length >=10){
                        var temphtml = aData[8].toString().substr(0,10)+"....."
                        $('td:eq(7)',nRow).html(temphtml);
                    }
                    $('td:eq(7)', nRow).hover( function(e) {
                    ...
                    $('td:eq(7)', nRow).mouseout(function(e){
...
/*********************************blackip_search*****************************************/
            driver_behaviour_search_oTable = $("#blackIp_list_search").dataTable({
                "oLanguage": {
                    "sProcessing":   "处理中...",
                    "sLengthMenu":   "显示 _MENU_ 项结果",
                    "sZeroRecords":  "没有匹配结果",
...
//                    }
    ...
    /*********************************driver_behaviour******************************************/
        // $('#driver_behaviour_filter').attr('style','height:25px;');
        // $("<button type='button' class='btn' style='float:right;margin-right:2px;' id='driver_behaviour_high_search' href='#inline_content'><i class='icon-search'></i>高级搜索</button> ").appendTo('#driver_behaviour_filter');
