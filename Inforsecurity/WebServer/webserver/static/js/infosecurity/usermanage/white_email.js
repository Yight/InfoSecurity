...
/*********************************white_email_list******************************************/
        ...
        $("<a href='#' class='btn' id='deleteblackemali'  style='float:right;width:66px;margin-right:2px;'><i class='icon-remove'></i>删除</a> <a href='#' class='btn' id='addwhiteemail' style='float:right;width:66px;margin-right:2px;'><i class='icon-plus'></i>添加</a>").appendTo('#white_email_list_filter');
/*********************************blackemail******************************************/
