...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Alarminfo.rank'
        db.delete_column(u'alarminfo', 'rank')

        # Adding field 'Alarminfo.rankid'
        db.add_column(u'alarminfo', 'rankid',
                      self.gf('django.db.models.fields.CharField')(default='b', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Alarminfo.rank'
        db.add_column(u'alarminfo', 'rank',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=3),
                      keep_default=False)

        # Deleting field 'Alarminfo.rankid'
        db.delete_column(u'alarminfo', 'rankid')
    ...
    models = {
        ...
        'engine.alarminfo': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rankid': ('django.db.models.fields.CharField', [], {'max_length': '3'}),
