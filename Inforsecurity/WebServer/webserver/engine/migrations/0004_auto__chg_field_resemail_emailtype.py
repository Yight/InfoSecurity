...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResEmail.emailtype'
        db.alter_column(u'res_email', 'emailtype', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'ResEmail.emailtype'
        db.alter_column(u'res_email', 'emailtype', self.gf('django.db.models.fields.IntegerField')())
